...
class tickerScrapper:
    ...
    def __scrapDates(self):
        dates = self.driver.find_element_by_css_selector("#Col1-1-Financials-Proxy > section > div:nth-of-type(4) > div > div:nth-of-type(1) > div:nth-of-type(1)").text
        dates = dates[13:]
    ...
    def __scrapRow(self, rows, index):
        res = rows.find_element_by_css_selector(f"div:nth-of-type({index})").text.split('\n')
        res = res[1].split(' ')
    ...
    def __parser(self):
        try:
            rows = self.driver.find_element_by_css_selector("#Col1-1-Financials-Proxy > section > div:nth-of-type(4) > div > div:nth-of-type(1) > div:nth-of-type(2)")
    ...
    def tickersExist(self, ticker):
        try:
            self.driver.get("https://finance.yahoo.com/quote/" + ticker + "/financials")
